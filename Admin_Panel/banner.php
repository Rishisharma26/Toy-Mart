...
<main class="mt-5 pt-2">
    <div class="container-fluid">
        <div class="row my-3">
               <div class="col-md-12 fw-bold fs-3">Banner</div>
               <div class="col-md-12 fw-bold fs-5 addcat mt-3"><a href="manage_banner.php">Add Banner <img src="icons/plus-circle-solid.svg" alt=""></a></div>
        </div>
        <div class="row">
                    ...
                    <?php 
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                echo "<span class='btn_edit'><a href='manage_banner.php?id=".$row['id']."' >Edit</a></span>&nbsp";
